...
function precomputeValues() {
    ...
    pitchValues = useDrawnPitch ? computeInterpolatedValues(pitchPoints, audioDuration, true) : computeInterpolatedValues(predefinedProfile(profilePitch, audioDuration), audioDuration, true);
}
